...
public class SrvThread extends Thread{
	...
	public void run() {
	    ...
	    try {
    		...
    		//Genera G y P de Diffie-Hellman
    		generateGandP();
	...
	private boolean opt1(String str_valor_comun, PrintWriter ac, BufferedReader dc, 
		...
		boolean exito = true;
		String msj = g.toString()+","+p.toString()+","+str_valor_comun;
		//Verifica el mensaje con la llave privada del servidor
		...
		//Verifica que está correcta la linea
	...
	private boolean opt2 (String str_valor_comun, PrintWriter ac, BufferedReader dc, BigInteger bix, PrivateKey privadaServidor) throws Exception {
		System.out.println("Todo debería funcionar perfecto");
		String linea;
