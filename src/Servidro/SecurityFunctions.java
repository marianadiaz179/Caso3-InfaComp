...
public class SecurityFunctions {
    ...
    public byte[] sign(PrivateKey privada, String mensaje) throws Exception {
		// Inicializa el objeto de la firma privada
        Signature privateSignature = Signature.getInstance("SHA256withRSA");
		//Inicializa el objeto con la llave privada que le entra por parametro
        privateSignature.initSign(privada);
		//Verifica el mensaje que recibe con la llave generada
